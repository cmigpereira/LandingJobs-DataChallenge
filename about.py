...
def app():
    ...
    - Employer Size: The size of organizations affects their structures, resulting in varying salaries.
    ...
    - Age: Not only related to working experience but also to the natural desire for stability and the recognition of knowledge.
    - Salary Fairness: Different industries have better profitability rates, which increases the employees' salaries, making employees feel that they're fairly paid.
