...
def app():
    ...
    st.text("\n")
    st.write("This page predicts the salary a given employee should be earning today according to the profile")
    st.markdown("***")
    ...
    with left_column:
        ...
        work_company_pt_district = st.selectbox("Employer Portugal District", (sorted(features['Work_Company_PT_District'])), index = 11,
